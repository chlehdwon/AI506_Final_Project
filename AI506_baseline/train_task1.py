...
def train():
    ...
    # Model preparation
    model = Task1transformer_CP(product_vocab_size=args.product_vocab_size,
    ...
    start_epoch = 0
    if args.resume:
        model_checkpoint = torch.load(f"./task1_checkpoint_embed/{args.resume_epoch}.pth")
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        }, f"./task1_checkpoint_embed/{epoch}.pth")
        ...
        if best_accuracy < validation_accuracy:
            ...
            torch.save({
                ...
                'model_state_dict': model.state_dict(),
                'optim_state_dict': optim.state_dict(),
            }, f"./task1_checkpoint_embed/best.pth")
